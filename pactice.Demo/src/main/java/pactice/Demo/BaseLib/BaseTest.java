...
public class BaseTest {
	...
	public String url = "https://www.airtel.in/s/selfcare?normalLogin";
	...
	public void setupTestMethod(Method method) {
		...
		declareScreenShotPaths("C:\\Users\\Automation\\Desktop\\pactice.Demo\\ScreenShots\\myAirtleImgaeValidation\\BaseLineScreenShot.png", testName + "_Actual.png","C:\\Users\\Automation\\Desktop\\pactice.Demo\\Differences\\myAirtleImgaeValidation_Actual.png");
	}
	...
	public Screenshot takeScreenshot(WebElement element) {
		...
		/*
		 * Screenshot elementScreenShot = new AShot() .coordsProvider(new
	...
	public void declareScreenShotPaths(String baseline, String actual, String diff) {
		...
		baselineScreenShotPath =  baseline;
		actualScreenShotPath = testScreenShotDirectory + actual;
		differenceScreenShotPath =diff;
	...
	public void compareImagesWithImageMagick(String expected, String actual, String difference) throws Exception {
		...
		// This is the core class of the im4java-library where all the magic takes
		// place.
		// ProcessStarter.setGlobalSearchPath("C:\\Program
		// Files\\ImageMagick-7.0.4-Q16");
		...
		// a count of the actual number of pixels that were masked, at the current fuzz
		// factor.
		cmpOp.metric("AE");
